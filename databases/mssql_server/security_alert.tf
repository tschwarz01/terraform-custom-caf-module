...
data "azurerm_storage_account" "mssql_security_alert" {
  ...
  name                = var.remote_objects.storage_accounts[var.settings.security_alert_policy.storage_account.key].name
  resource_group_name = var.remote_objects.storage_accounts[var.settings.security_alert_policy.storage_account.key].resource_group_name
}
