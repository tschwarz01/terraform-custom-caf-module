...
module "lb_backend_address_pool" {
  source   = "./networking/lb_backend_address_pool"
...
module "lb_backend_address_pool_address" {
  source   = "./networking/lb_backend_address_pool_address"
...
module "lb_outbound_rule" {
  source   = "./networking/lb_outbound_rule"
